...
export default function HomeSubscribe() {
  ...
  if (status === "done") {
    return (
      <p className="flex items-center gap-2.5 border-t border-dashed border-[#F0E2D6] px-3 pb-1 pt-4 text-sm font-semibold text-emerald-700">
  ...
  return (
    <form
      onSubmit={submit}
      className="border-t border-dashed border-[#F0E2D6] px-3 pb-1 pt-4"
    >
      <label
