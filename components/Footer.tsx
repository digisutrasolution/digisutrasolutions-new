      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-[1280px] px-4 py-12 sm:px-6 sm:py-16">
          ...
          {/* We Accept — mobile: a uniform 3-column grid so the six badges
              ...
              Bank Transfer) as they did in a flex row. From sm the six go in
              ...
              row empty. Deliberately sm and not md — an unfolded Fold 6
              reports under 768px, so an md breakpoint never fired there. */}
          <div className="mt-6 border-t border-white/10 pt-5 lg:hidden">
            <p className="mb-3 text-[0.85rem] font-black uppercase tracking-wide text-[#F26419]">
              We Accept
            </p>
            <div className="grid max-w-[340px] grid-cols-3 gap-2 sm:max-w-none sm:grid-cols-6">
