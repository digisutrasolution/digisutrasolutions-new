  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-stone-500 dark:text-stone-400">
        Testimonials, client logos and case studies — plus the review-request
        page clients land on. Every entry is a public claim about a real client,
        so nothing here ships with sample data: each block stays hidden on the
        site until you add a real one.
      </p>
      <div className="mt-6">
        <ProofManager
