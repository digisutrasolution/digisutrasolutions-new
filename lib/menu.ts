...
export const DEFAULT_NAV: NavNode[] = [
  ...
  },
  {
    ...
    children: [
      { label: "Website Design & Development", href: "/services/website-design-development", icon: "monitorSmartphone", group: "Build & Development", description: "Fast, SEO-ready sites and stores" },
      { label: "Mobile App Development", href: "/services/mobile-app-development", icon: "smartphone", group: "Build & Development", description: "Android & iOS from one codebase" },
      { label: "Branding & UI/UX", href: "/services/branding-ui-ux", icon: "palette", group: "Build & Development", description: "Identity and interfaces people trust" },
      { label: "SEO + AI Search Optimization", href: "/services/seo-ai-search", icon: "search", badge: "AEO · GEO", group: "Marketing & Growth", description: "Rank on Google — and get cited by AI answers" },
      { label: "Performance Marketing", href: "/services/performance-marketing", icon: "trendingUp", group: "Marketing & Growth", description: "Google, Meta & LinkedIn ads run for ROAS" },
      { label: "AI Automation", href: "/services/ai-automation", icon: "bot", badge: "NEW", group: "AI & Automation", description: "Bots that capture and qualify leads 24/7" },
      { label: "CRM & Lead Management", href: "/services/crm-lead-management", icon: "database", group: "AI & Automation", description: "Every lead tracked — nothing slips" },
    ],
  },
  {
    label: "Work",
